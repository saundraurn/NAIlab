...
* **Active Internet Search Required:** You MUST perform active web searches as the first step of any task involving external APIs, libraries, or CDN links. It is strictly required to verify you are referencing the most up-to-date documentation, syntax, and versioning before generating any code or suggestions. Perform searches for each area; do not just make one search.
